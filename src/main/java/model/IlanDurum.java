...
public enum IlanDurum {
    Uygun(1, true), KaraLisetede(2, false), AciklamadaUygunsuzlukVar(3, false), Hasarli(4, false), Istenmiyor(5, true), MaxFiyatiAsiyor(6, true) , PuanUygunDegil(7, true),YanlisBilgi(8, false), KmPuanUygunDegil(9, false);
